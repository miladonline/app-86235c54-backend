        ...
        contents=[
            types.TextResourceContents(
                ...
                _meta={
                    ...
                    "openai/widgetDescription": "Interactive hello world widget"
                }
            )
        ]
    )
...
async def _call_tool_request(
    ...
    if tool_name == "say_hello":
        ...
        data = {
            ...
            "name": name,
            "timestamp": "now",
            "message": "Welcome to your first MCP app!"
        }
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"{greeting} This is a simple hello world app. Interact with the widget below to see more.",
                )
            ],
            structuredContent={
                "greeting": greeting,
